...
#ファイル読み込み
data <- read.csv("csv/deathH25Female.csv")
...
plot(x=NULL, type="n", xlab="PC1", ylab="PC2", xlim=c(-10,10), ylim=c(-5,5), xaxs="i", yaxs="i", xaxt="n", yaxt="n", bty="n", main="大阪市　年齢調整死亡率（主な死因）平成25年　女性　主成分分析")
...
#描画
par(las=1, family="HiraKakuProN-W3")
plot(x=NULL, type="n", xlab="PC1", ylab="PC2", xlim=c(-0.5,0.5), ylim=c(-0.5,0.5), xaxs="i", yaxs="i", xaxt="n", yaxt="n", bty="n", main="大阪市　年齢調整死亡率（主な死因）平成25年　女性　主成分分析")
